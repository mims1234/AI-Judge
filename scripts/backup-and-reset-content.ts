 ...
 *   npx tsx scripts/backup-and-reset-content.ts
 *
 * Env: DATABASE_PATH (default ./data/ai-judge.sqlite)
 */
...
const users = src.prepare(`SELECT * FROM users`).all() as Record<string, unknown>[];
