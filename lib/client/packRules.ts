...
export const PACK_RULES = [
  ...
  "Must-mention phrases are judge-only. Candidates never see them. The lab drops any phrase that already appears in the task.",
  "The lab owns the JSON: every task uses { \"answer\": \"<your full response>\" }.",
  "The generator cannot invent schemas. We pin the footer.",
  "Bundle review labels weak tests. Publish needs judge criteria and a score of 6 or more. Copied-from-task must-mentions are removed for you.",
